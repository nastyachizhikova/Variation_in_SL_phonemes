...
def occupied(frames):
    ...
    for frame in frames:
        ...
        for c in cnts:
            ...
            if cv2.contourArea(c) < 1000.0:  # reduced from 9000.0 to 1000.0 to work with corpus data
                continue
...
def read_frames(video):
    ...
    # Sometimes the algorithm would not find occupied frames due to the quality of the corpus data
    if occupied_frames_ind == []:
        offset = 0
    else:
